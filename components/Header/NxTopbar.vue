    ...
    <div class="container mx-auto">
      <ul class="topbar-menu flex">
        <template v-for="(menuItem, index) in menuItems">
          <li
            class="sidebar-item mr-8"
            :key="index"
            v-if="menuItem.condition !== 'vertical-only'"
          >
              ...
              <template slot="button">
                ...
                >
                  ...
                  <transition name="fade-3s-instant">
                    <span
                      class="text-md ml-3 mt-1 sidebar-menu-text"
...
<style lang="scss">
#topbar {
  background: #fb6f92; /* fallback for old browsers */
  .dropdown-topbar {
    top: 50px;
  }
}
