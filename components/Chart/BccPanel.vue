...
import BccPanel from "@/assets/images/panels/BccPanel.svg?raw";
      ...
      option: {
        tooltip: {
          ...
          formatter: function (params) {
            return `<img src="@/assets/images/panels/spatial_metadata/bcc/cluster_0.png">`;
          },
        },
        series: [],
        geo: {
          tooltip: {
            ...
            formatter: function (params) {
              ...
              const img_url = require(`@/assets/images/panels/spatial_metadata/bcc/cluster_${cluster}.png`);
