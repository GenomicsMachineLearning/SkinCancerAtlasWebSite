        ...
        <div class="w-auto my-6 mx-auto max-w-6xl">
          ...
          >
            ...
            <div
              ...
              "
            >
              <h3 class="text-3xl font-semibold">Melanoma - CosMx datasets</h3>
              <button
                class="
                  p-1
                  ml-auto
                  ...
                  <nx-card>
                    ...
                    <template slot="body">
                      <div class="flex items-center justify-center">
                        <img
                          class="object-cover"
                          src="@/assets/images/panels/spatial_metadata/melanoma/SMIPanel.png"
                          alt="blue"
                        />
                      </div>
                    </template>
...
import SMIMelanomaPanel from "@/assets/images/panels/SMIMelanomaPanel.svg?raw";
...
export default {
  ...
  methods: {
    ...
    initChart() {
      ...
      registerMap("SMIMelanomaPanel", {
        svg: SMIMelanomaPanel,
      });
