        ...
        <div class="w-auto my-6 mx-auto max-w-6xl">
          ...
          >
            ...
            <div
              ...
              "
            >
              <h3 class="text-3xl font-semibold">BCC - CosMx datasets</h3>
              <button
                class="
                  p-1
                  ml-auto
                  ...
                  <nx-card>
                    ...
                    <template slot="body">
                      <div class="flex items-center justify-center">
                        <img
                          class="object-cover pt-5"
                          src="@/assets/images/panels/spatial_metadata/bcc/SMIPanel.png"
                          alt="blue"
                        />
                      </div>
                    </template>
...
import SMIBccPanel from "@/assets/images/panels/SMIBccPanel.svg?raw";
