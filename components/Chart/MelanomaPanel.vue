...
import MelanomaPanel from "@/assets/images/panels/MelanomaPanel.svg?raw";
      ...
      option: {
        tooltip: {
          ...
          formatter: function (params) {
            return `<img src="@/assets/images/panels/spatial_metadata/melanoma/cluster_0.png">`;
          },
        },
        series: [],
        geo: {
          tooltip: {
            ...
            formatter: function (params) {
              ...
              const img_url = require(`@/assets/images/panels/spatial_metadata/melanoma/cluster_${cluster}.png`);
